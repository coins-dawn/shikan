...
export default function Header({ currentScreen, navigateTo }: HeaderProps) {
  ...
  return (
    <header className="bg-white border-b border-gray-200 px-2 desktop:px-4 py-2 desktop:py-3 relative z-[90]">
      <div className="flex items-center justify-between">
        ...
        >
          ...
          >
            <path
              fill="currentColor"
              d="M440.286,108.659H58.524c-12.164,0-23.058,7.928-26.761,19.459L3.977,213.405
            ...
            <path
              fill="currentColor"
              d="M124.439,313.235c-24.882,0-45.053,20.172-45.053,45.057c0,24.886,20.171,45.048,45.053,45.048
            ...
            <path
              fill="currentColor"
              d="M397.113,313.235c-24.882,0-45.053,20.172-45.053,45.057c0,24.886,20.171,45.048,45.053,45.048
